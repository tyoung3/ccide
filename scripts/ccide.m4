...
^^^[[ -x $BINDIR/ccidew.exe ]]%%% && CCIDE=$((CCIDE+=64)) 
	...
	CCIDE_CASE(1,0,1)
	    ...
	    CCIDE_BREAK()
	CCIDE_END_SWITCH()
CCIDE_COMMENT(^^^END_GENERATED_CODE: FOR TABLE_1, by ccide-0.7.0-0 Sun 07 Aug 2022 10:47:21 AM EDT %%%)
...
while [[ $# > 0 ]]; do
	...
	^^^[[ ("$1" == "-V") || ("$1" == "--version") ]]%%% && CCIDE=$((CCIDE+=8)) 
		...
		CCIDE_CASE(2,0,1)
		    ...
		    CCIDE_BREAK()
		CCIDE_END_SWITCH()
	CCIDE_COMMENT(^^^END_GENERATED_CODE: FOR TABLE_2, by ccide-0.7.0-0 Sun 07 Aug 2022 10:47:21 AM EDT %%%)
	shift
done
...
^^^[[ "$CCIDELANG" == "CH" ]]%%% && CCIDE=$((CCIDE+=8)) 
	...
	CCIDE_CASE(3,0,1)
	    ...
	    CCIDE_BREAK()
	CCIDE_END_SWITCH()
CCIDE_COMMENT(^^^END_GENERATED_CODE: FOR TABLE_3, by ccide-0.7.0-0 Sun 07 Aug 2022 10:47:21 AM EDT %%%)
...
^^^[[ "$CCIDELANG" == "EX" ]]%%% && CCIDE=$((CCIDE+=2)) 
	...
	CCIDE_CASE(4,2,2)
	    ...
	    CCIDE_BREAK()
	CCIDE_END_SWITCH()
CCIDE_COMMENT(^^^END_GENERATED_CODE: FOR TABLE_4, by ccide-0.7.0-0 Sun 07 Aug 2022 10:47:21 AM EDT %%%)
