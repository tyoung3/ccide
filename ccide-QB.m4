...
rem ccide-VB.m4
	rem Copyright (C) 2002-2004 Thomas W. Young, e-mail:  ccide@twyoung.com
	rem This code (generated by ccide) is licensed under the GNU Library
	rem General Public License
	rem As such, it may be freely used, even link-editted with proprietary code
